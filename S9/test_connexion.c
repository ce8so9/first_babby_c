...
int main(int argc, char *argv[])
{
  ...
  fprintf(stderr, "Construction de l'ABR\n");
  ...
  fprintf(stderr, "Destruction de l'ABR\n");
  detruire_abr(abr_sta);

  fprintf(stderr, "Destruction de la liste des stations\n");
  detruire_liste_et_truc(liste_sta);

  fprintf(stderr, "Destruction de la liste des connexions\n");
  detruire_liste_et_truc(liste_con);

  fprintf(stderr, "Destruction des lignes\n");
